...
<div class="row">
  <div class="col-xl-6 col-12">
    ...
    <p class="text-light-gray mb-4">
      ...
      — It was created from algorithms and rules using the Processing software.<br/><br/>
      — The output was printed on 11x11" Bristol paper ( 270g/m2 ) using a 0.2mm rOtring pen with black archival ink.
    </p>

    <p>
      A limited edition print of the artwork is optionally included for the first buyer of the NFT on <a href="https://foundation.app/@bustavo/bustavo/1" target="_blank">Foundation</a> ( see below ).
    </p>
...
<div class="row">
  ...
  <div class="col-xl-6 col-12">
    ...
    <p>
      ...
      <a href="https://foundation.app/@bustavo/bustavo/1" target="_blank">Omega NFT on Foundation</a><br/><br/>
